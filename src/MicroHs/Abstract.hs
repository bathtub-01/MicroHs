...
-- Standard procesure of combining two combinator expressions.
-- Assuming both of them are in "unary form".
...
-- this rule always assume a1 and a2 are "unary", depractreated..
...
-- ========================= Achieve fully laziness ==========================
-- (see John Hughes's paper: https://dl.acm.org/doi/abs/10.1145/800068.802129)
